...
class TestT:
    ...
    def test_simple_key(self):
        assert t("en", "soul.time_lapse", seconds=120) == "120 seconds passed, think."

    def test_chinese_key(self):
        assert t("zh", "soul.time_lapse", seconds=120) == "已过去120秒，思考"
    ...
    def test_unknown_lang_falls_back_to_en(self):
        assert t("xx", "soul.time_lapse", seconds=60) == "60 seconds passed, think."
